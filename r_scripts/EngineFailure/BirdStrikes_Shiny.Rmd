...
engine.data <- readRDS("../../data/KDEN_EngineFailure.RDS")
...
sub <- caret::createDataPartition(model.data$eng_fail, p = 0.8, list = FALSE)
...
tcbPalette <- c("#006ba4","#C85200","#595959","#A2C8EC","#FF800E","#898989","#ABABAB","#FFBC79","#5F9ED1","#CFCFCF","#000000")
...
ggplot(temp_df,
  ...
  labs(title = "Frequency of Bird Strikes by Phase of Flight",
       ...
       x ="Phase of Flight")+
  theme_clean()+
  scale_fill_manual(values=tcbPalette)+
...
renderPlot({
  if (input$modelName == "lr")
  {
    ...
    plot(roc.nb, col = "#c85200", add = TRUE)
    plot(roc.svm, col = "#595959", add = TRUE)
    plot(roc.rf, col = "#a2c8ec", add = TRUE)
    ...
    legend(
      ...
      inset = .025,
      fill = c("#006ba4", "#c85200", "#595959", "#a2c8ec")
    )
    segments(0, 0, 1, 1, lty = 4)
  }
  plot.roc
...
![Left -> Right: Ricky, Mariana, Tanu, Krishna, Christian](www/About_Us_Picture.jpg)

    
### **Get to Know Us**

![](www/About_Us_Table.jpg)