...
eng.data <- readRDS("../../data/KDEN_EngineFailure.RDS")
...
write_csv(test.data,
  paste("../../data/", "testdata_engfail.RDS", sep = "")
)
```
...
saveRDS(lr.model, paste("../../data/","model_lr",".rds",sep = ""))
...
saveRDS(NBclassfier, paste("../../data/","model_nb",".rds",sep = ""))
...
saveRDS(svm_model, paste("../../data/","model_svm",".rds",sep = ""))
...
saveRDS(rf.model, paste("../../data/","model_rf",".rds",sep = ""))
